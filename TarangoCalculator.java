...
import javax.swing.*;
public class TarangoCalculator extends JFrame
{
   private JButton Bone,Btwo,Bthree,Bfour,Bfive,Bsix,Bseven,Beight,Bnine,Bzero,Bplus,Bminus,Bmultiple,Bproduct,Bequal,Bans;
   ...
   int AfterAnswer = 0;
   /*
   Here the value of the variables AfterEqual,SymbolMark & AfterAnswer are made 0 when their related buttons
   are pressed by the user but the values are again made 0 when they are used.
   */
   double Ans;
   double ButtonValue;
   String Symbol;
   String Text;
   //When any number button is pressed this method store that number in a array...
  ...
  public void MethodForCutButton(){
   ...
   {
     TarangoCalculator MC = new TarangoCalculator();
   }
}
